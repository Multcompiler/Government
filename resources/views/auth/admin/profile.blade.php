            ...
            <div class="col-md-8 col-xs-12 col-md-offset-2">
                <div class="white-box">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="settings">
                            {!! Form::model($district_profile, ['route' => ['edit_profile_admin', $district_profile->id],'method' => 'PUT','class' => 'form-horizontal form-material'],['data-parsley-validate' => '']) !!}
                ...
                <div class="col-md-8 col-xs-12 col-md-offset-2">
                    <div class="white-box">
                        ...
                        <form class="form-horizontal form-material" action="{{route('profile_add_admin')}}" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
