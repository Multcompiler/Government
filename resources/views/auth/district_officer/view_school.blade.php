                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <div class="col-sm-12">
                            ...
                            <div class="white-box">
                                @if($data_school == 0)
                                    <h2 class="m-b-0 text-center" style="text-transform: uppercase;">No Requirements Added For This School</h2>
                                    ...
                                    @foreach($requirements_total as $requirement)
                                        @if($requirement->kidato_id == $duplicateRecords[$i]->kidato_id)
                                            ...
                                            @if(\App\UserSchool::where("id",$requirement->requirement_category_id)->pluck("user_category")->first() == "Students")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-xs-6 b-r"><strong>Category</strong>
                                                        <br>
                                                        <p class="text-muted">
                                                    ...
                                                    <div class="col-md-4 col-xs-6 b-r"><strong>Male Total</strong>
                                                        <br>
                                                        <p class="text-muted">{{$requirement->male_total}}</p>
                                                    </div>

                                                    <div class="col-md-4 col-xs-6 b-r"><strong>Female Total</strong>
                                                        <br>
                                                        <p class="text-muted">{{$requirement->female_total}}</p>
                                                    </div>
                                                    <div class="col-md-4 col-xs-6"><strong>Date</strong>
                                                        <br>
                                                        <p class="text-muted">{{date('Y-M-d',strtotime($requirement->created_at))}}</p>
                                                    </div>
